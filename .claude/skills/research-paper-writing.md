...
2. Use section-specific guidance in `research-paper-writing/references/`.
...
6. Run final-paper adversarial review with `research-paper-writing/references/paper-review.md`.
...
- Paper review (Paper Review): `research-paper-writing/references/paper-review.md`
- Paragraph clarity source: `research-paper-writing/references/does-my-writing-flow-source.md`
- Example bank index: `research-paper-writing/references/examples/index.md`

## Paper Review Core Points

Use `research-paper-writing/references/paper-review.md` for the full checklist and workflow.
